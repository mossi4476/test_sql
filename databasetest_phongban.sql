...
CREATE TABLE `phongban` (
  ...
  `MaPhongBan` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `TenPhongBan` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
INSERT INTO `phongban` VALUES (1,'1','Test');
